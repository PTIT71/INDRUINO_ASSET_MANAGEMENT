				...
				<form action="BorrowAssetRegister" method="POST">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="title_input">CÔNG TY:</label> <br> <input
									...
									id="loan_cmpn_cd" list="loan_cmpn_cd_item" value="" class="form-control"
									name="loan_cmpn_cd">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="title_input">ĐƠN VỊ</label> <br> <input
									type="text" class="form-control" id="loan_cmpn_dept" value="${asset.getLoan_dept()}"" name="loan_cmpn_dept">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
								<label class="title_input">NGÀY CHO MƯỢN</label> <br> <input
									type="date" class="form-control" value="${asset.getLoad_Date()}" name="loan_date">
							</div>
						</div>
					</div>
						...
						<div class="col-sm-3">
							<div class="form-group">
								<label class="title_input">TÊN TÀI SẢN</label> <input
									type="text" class="form-control" value="${asset.getAsset_name()}" name="asset_name">
							</div>
						</div>
						<div class="col-sm-3">
							<div class="form-group">
								<label class="title_input">MÃ RFID:</label> <input type="text"
									class="form-control" value="${asset.getAsset_rfid()}"  name="asset_rfid">
							</div>
						</div>
						...
						<div class="col-sm-3">
							<div class="form-group">
								<label class="title_input">MODEL:</label> <input type="text"
									class="form-control" value="${asset.getAsset_model()}" name="asset_model">
							</div>
						</div>
						<div class="col-sm-3">
							<div class="form-group">
								<label class="title_input">SỐ SERIES:</label> <input type="text"
									class="form-control" value="${asset.getAsset_series()}" name="asset_series">
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="title_input">ĐƠN VỊ</label> <br> <input
									type="text" class="form-control"  value="${asset.getBorrow_dept()}" name="borrow_cmpn_dept">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
								<label class="title_input">NGÀY TRẢ</label> <br> <input
									type="date" class="form-control" value="${asset.getLoad_Date()}" name="borrow_date">
							</div>
						</div>
						<div class="col-sm-12">
							<div class="form-group">
