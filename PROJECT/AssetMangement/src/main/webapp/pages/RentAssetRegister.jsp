					...
					<div class="row">
						<div class="col-sm-4">
							<div class="input-group">
								...
								</span> <input type="text" placeholder="Tên cơ sở thuê" class="form-control inputAssetItem"
									name="company_name">
							</div>
						</div>
						...
						<div class="col-sm-4">
							<div class="input-group">
								<span class="input-group-addon"> <label
									...
									<input type="text" class="form-control inputAssetItem" style="display: none;"
									name="department_cd" id="department_cd">
									<button type="button" class="select" onclick="return openDialogue('GetListDepartment')"><i class="fas fa-list-alt"></i></button>
							</div>
						</div>
