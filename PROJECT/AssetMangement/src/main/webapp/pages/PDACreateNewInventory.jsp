	...
	<form action="PDACreateNewInventory" 
		...
		<div>
			<c:if test="${message != null}">
				<div class="alert alert-danger message" style="margin-top: 20px !important">
					<strong>${message}</strong>
				</div>
			</c:if>
			<c:if test="${NOTIFICATION != null}">
				<div class="alert alert-success message" style="margin-top: 20px !important">
		...
		<div class="form-group">
			<label class="title" for="usr">TÊN TÀI SẢN:</label> <input
				type="text" required style="background-color: green;" class="form-control"
				value="" name="asset_name">
		</div>
		<div class="form-group">
			<label class="title" for="usr">VỊ TRÍ:</label> <input type="text"
				style="background-color: green;" required class="form-control" value=""
				name="department">
		</div>
		<div class="form-group">
			<label class="title" for="usr">LÝ DO BÁO MỚI:</label>
			<textarea name="reason" required style="width: 100%; height: 200px; resize: none;"></textarea>
		</div>
		<div class="form-group">
			<label class="title" for="usr">GHI CHÚ:</label>
			<textarea name="note" style="width: 100%; height: 100px; resize: none;"></textarea>
		</div>
