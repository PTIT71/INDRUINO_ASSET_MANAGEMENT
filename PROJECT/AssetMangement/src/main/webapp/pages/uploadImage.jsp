<%@page import="com.asset.management.controller.PhotoController"%>
<%@page import="com.asset.management.controller.UploadImageController"%>
...
<html>
    <head>
        ...
        <%
            String baseURL = (String) request.getAttribute(UploadImageController.PARAM_BASE_URL);
