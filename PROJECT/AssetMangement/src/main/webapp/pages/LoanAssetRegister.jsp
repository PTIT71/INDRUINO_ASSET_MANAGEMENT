					...
					<div class="row">
						<div class="col-sm-4">
							<div class="form-group">
								<label class="title_input">CÔNG TY:</label> <br> <input readonly="readonly"
									style="width: 35%; display: inline-block;" type="text"
									id="loan_cmpn_cd" value="${loan_cmpn_cd}"  class="form-control"
									name="loan_cmpn_cd">
								


								<input type="text" style="width: 60%; display: inline-block;" readonly="readonly"
							...
							<div class="form-group">
								<label class="title_input">CÔNG TY:</label> <br> <input
									style="width: 35%; display: inline-block;" 
									 type="text" class="form-control" id="borrow_cmpn_cd"
									name="borrow_cmpn_cd" list="borrow_cmpn_cd_item"> 
									<datalist class="selectList-item" id="borrow_cmpn_cd_item">
