			...
			<div class="col-sm-12 general-setting shadow-sm p-3 mb-5 bg-gray">
				<form action="AssetGeneralUpdate" method="POST">
					...
					<div class="col-sm-4">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="title_input">MODEL:</label> <input type="text" value="${asset.getModel()}"
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="title_input">ĐƠN VỊ:</label> <input type="text"
									class="form-control" value="${asset.getDepartment()}" name="asset_department">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
								<label class="title_input">MÃ KẾ TOÁN:</label> <input
									type="text" value="${asset.getAccountant_CD()}" class="form-control" name="asset_accountant">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
								<label class="title_input">NGÀY ĐẦU TƯ:</label> <input
									type="date" value="${asset.getDateStart()}" class="form-control" name="asset_date">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
