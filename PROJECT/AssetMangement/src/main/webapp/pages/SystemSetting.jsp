				...
				<div class="block-feature" style="margin-top: 0px;">
					...
					<div>
						<div class="option-feature">
							<div class="row">
								<div class="col-sm-6">
									<div class="feauture">
										<h4 class="level1">2 Nghiệp vụ</h4>
										<a href="MajorManagement"><i class="fa fa-arrow-right"></i>Quản lý nghiệp vụ</a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="option-feature">
						<div class="row">
							<div class="col-sm-6">
								<div class="feauture">
									<h4 class="level1">${company.getName() }</h4>
									<h4 class="level2">${company.getAddress() }</h4>
